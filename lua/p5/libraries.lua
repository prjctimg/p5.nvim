...
L.load_libs_json = function()
	...
	local data, err = core.r_json(libs_file)
...
L.uninstall_libs = function(lib_names)
	...
	local config = core.r_ss_cfg() or { libs = {}, includes = { "sketch.js" } }
	config.libs = config.libs or {}
