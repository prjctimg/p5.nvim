...
H.check_dependencies = function()
	vim.health.start("🌸 p5.nvim healthcheck")
...
H.check_plugin_env = function()
	...
	if core.chkdir(plugin_root, "Plugin root", false) then
	...
	if core.chkdir(asset_dir, "Asset directory", false) then
...
H.check_project_config = function()
	...
	if core.chkfile(config_file, "p5.json", false) then
...
H.check_workspace = function()
	...
	if core.chkdir(tmp_dir, "Cache directory", false) then
