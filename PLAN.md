...
- Server type auto-detection (live-server, python,deno,bun)
...
- The types and core modules (p5.js and p5.sound) should be downloaded from a CDN and copied to the p5.nvim repo whenever new release of p5 is made
