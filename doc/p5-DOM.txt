📄 *p5.DOM*📄
DOM module functions and properties

==============================================================================
Tags p5.DOM DOM module functions and properties
==============================================================================
...
CLASSES                                                   *p5-DOM-classes*

p5-DOM_Anonymous() 📄 🏛️
|Anonymous|() 🏛️ Class

A class to describe an <a href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML/Getting_started" target="_blank">HTML element</a>.
Sketches can use many elements.
Common elements include the drawing canvas, buttons, sliders, webcam feeds, and so on.
All elements share the methods of the `p5.Element` class.
They're created with functions such as <a href="#/p5/`createCanvas`">`createCanvas`()</a> and <a href="#/p5/createButton">createButton()</a>.

Parameters: ~
                🔢 `elt` (HTMLElement) - wrapped DOM element.
                🔢 `{p5} [pInst] pointer to p5 instance.` (unknown)
~
...
Source: ~
                ../temp/src/core/p5.Element.js:54
~
...
See also: ~
   |help p5-Cue| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:4086
~
...
See also: ~
   |help p5-Element| for detailed help on this symbol~
...
`p5.File` objects are used by <a href="#/p5.Element/drop">myElement.drop()</a> and created by <a href="#/p5/createFileInput">createFileInput</a>.
...
See also: ~
   |help p5-File| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5571
~


FUNCTIONS                                                   *p5-DOM-functions*

p5-DOM_addClass() 📄 ⚡
|addClass|(class) ⚡ Function
...
See also: ~
   |help p5-addClass| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2582
~
...
See also: ~
   |help p5-addElement| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:481
~
...
See also: ~
   |help p5-attribute| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3336
~


p5-DOM_center() 📄 ⚡
|center|({String} [align] passing 'vertical', 'horizontal' aligns element accordingly) ⚡ Function
...
Parameters: ~
                🔢 `{String} [align] passing 'vertical', 'horizontal' aligns element accordingly` (unknown)
~
...
See also: ~
   |help p5-center| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2861
~
...
See also: ~
   |help p5-changed| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:400
~


p5-DOM_child() 📄 ⚡
|child|({String|p5.Element} [child] the ID, DOM node, or <a href="#/p5.Element">p5.Element</a>) ⚡ Function

Parameters: ~
                🔢 `{String|p5.Element} [child] the ID, DOM node, or <a href="#/p5.Element">p5.Element</a>` (unknown)
~

See also: ~
   |help p5-child| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2808
~
...
See also: ~
   |help p5-controls| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5260
~


p5-DOM_createA() 📄 ⚡
|createA|(href, html, {String} [target]   target where the new link should open,) ⚡ Function
...
The second parameter, `html`, is a string that sets the inner HTML of the link.
It's common to use `text`, images, or buttons as links.
The third parameter, `target`, is optional.
It's a string that tells the web browser where to open the link.
By default, links open in the current browser tab.
Passing `'_blank'` will cause the link to open in a new browser tab.
MDN describes a few <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a#target" target="_blank">other options</a>.

Parameters: ~
                📝 `href` (String) - URL of linked page.
                📝 `html` (String) - inner HTML of link element to display.
                🔢 `{String} [target]   target where the new link should open,` (unknown)
~

Returns: ~
                🔢 Returns p5.Element: new <a href="#/p5.Element">p5.Element</a> object.
~
...
See also: ~
   |help p5-createA| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:778
~


p5-DOM_createAudio() 📄 ⚡
|createAudio|({String|String[]} [src] path to an audio file, or an array of paths, {Function} [callback]   function to call once the audio is ready to play.) ⚡ Function

Creates a hidden `&lt;audio&gt;` element for simple audio playback.
`createAudio()` returns a new <a href="#/p5.MediaElement">p5.MediaElement</a> object.
The first parameter, `src`, is the path the video.
If a single string is passed, as in `'assets/video.mp4'`, a single video is loaded.
An array of strings can be used to load the same video in different formats.
For example, `['assets/video.mp4', 'assets/video.ogv', 'assets/video.webm']`.
This is useful for ensuring that the video can play across different browsers with different capabilities.
See <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Supported_media_formats" target="_blank">MDN</a> for more information about supported formats.
The second parameter, `callback`, is optional.
It's a function to call once the audio is ready to play.

Parameters: ~
                🔢 `{String|String[]} [src] path to an audio file, or an array of paths` (unknown)
                🔢 `{Function} [callback]   function to call once the audio is ready to play.` (unknown)
~

Returns: ~
                🔢 Returns p5.MediaElement: new <a href="#/p5.MediaElement">p5.MediaElement</a> object.
~
...
See also: ~
   |help p5-createAudio| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2254
~


p5-DOM_createButton() 📄 ⚡
|createButton|(label, {String} [value] value of the button.) ⚡ Function

Creates a `&lt;button&gt;&lt;/button&gt;` element.
The first parameter, `label`, is a string that sets the label displayed on the button.
The second parameter, `value`, is optional.
It's a string that sets the button's value.
See <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button#value" target="_blank">MDN</a> for more details.

Parameters: ~
                📝 `label` (String) - label displayed on the button.
                🔢 `{String} [value] value of the button.` (unknown)
~
...
See also: ~
   |help p5-createButton| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:1000
~


p5-DOM_createCapture() 📄 ⚡
|createCapture|({String|Constant|Object}  [type] type of capture, either AUDIO or VIDEO,, {Object}                  [flipped] flip the capturing video and mirror the output with `{flipped:true}`. By, {Function}                [callback] function to call once the stream) ⚡ Function

Creates a `&lt;video&gt;` element that "captures" the audio/video stream from the webcam and microphone.
`createCapture()` returns a new <a href="#/p5.MediaElement">p5.MediaElement</a> object.
Videos are shown by default.
They can be hidden by calling `capture.hide()` and drawn to the canvas using <a href="#/p5/`image`">`image`()</a>.
The first parameter, `type`, is optional.
It sets the type of capture to use.
By default, `createCapture()` captures both audio and video.
If `VIDEO` is passed, as in `createCapture(VIDEO)`, only video will be captured.
If `AUDIO` is passed, as in `createCapture(AUDIO)`, only audio will be captured.
A constraints object can also be passed to customize the stream.
See the <a href="http://w3c.github.io/mediacapture-main/getusermedia.html#media-track-constraints" target="_blank"> W3C documentation</a> for possible properties.
...
The second parameter,`callback`, is optional.
It's a function to call once the capture is ready for use.
The callback function should have one parameter, `stream`, that's a <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaStream" target="_blank">MediaStream</a> object.
Note: `createCapture()` only works when running a sketch locally or using HTTPS.
Learn more <a href="http://stackoverflow.com/questions/34197653/getusermedia-in-chrome-47-without-using-https" target="_blank">here</a> and <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia" target="_blank">here</a>.

Parameters: ~
                🔢 `{String|Constant|Object}  [type] type of capture, either AUDIO or VIDEO,` (unknown)
                🔢 `{Object}                  [flipped] flip the capturing video and mirror the output with `{flipped:true}`. By` (unknown)
                🔢 `{Function}                [callback] function to call once the stream` (unknown)
~
...
See also: ~
   |help p5-createCapture| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2415
~


p5-DOM_createCheckbox() 📄 ⚡
|createCheckbox|({String} [label] label displayed after the checkbox., {boolean} [value] value of the checkbox. Checked is `true` and unchecked is `false`.) ⚡ Function

Creates a checkbox `&lt;input&gt;&lt;/input&gt;` element.
Checkboxes extend the <a href="#/p5.Element">p5.Element</a> class with a `checked()` method.
Calling `myBox.checked()` returns `true` if it the box is checked and `false` if not.
The first parameter, `label`, is optional.
It's a string that sets the label to display next to the checkbox.
The second parameter, `value`, is also optional.
It's a boolean that sets the checkbox's value.

Parameters: ~
                🔢 `{String} [label] label displayed after the checkbox.` (unknown)
                🔢 `{boolean} [value] value of the checkbox. Checked is `true` and unchecked is `false`.` (unknown)
~
...
See also: ~
   |help p5-createCheckbox| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:1104
~


p5-DOM_createColorPicker() 📄 ⚡
|createColorPicker|({String|p5.Color} [value] default color as a <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color" target="_blank">CSS color string</a>.) ⚡ Function

Creates a `color` picker element.
The parameter, `value`, is optional.
If a `color` string or <a href="#/p5.Color">p5.Color</a> object is passed, it will `set` the default `color`.
Color pickers extend the <a href="#/p5.Element">p5.Element</a> class with a couple of helpful methods for managing colors: - `myPicker.value()` returns the current `color` as a hex string in the format `'#rrggbb'`.
- `myPicker.`color`()` returns the current `color` as a <a href="#/p5.Color">p5.Color</a> object.

Parameters: ~
                🔢 `{String|p5.Color} [value] default color as a <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color" target="_blank">CSS color string</a>.` (unknown)
~
...
See also: ~
   |help p5-createColorPicker| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:1823
~


p5-DOM_createDiv() 📄 ⚡
|createDiv|({String} [html] inner HTML for the new `&lt;div&gt;&lt;/div&gt;` element.) ⚡ Function

Creates a `&lt;div&gt;&lt;/div&gt;` element.
`&lt;div&gt;&lt;/div&gt;` elements are commonly used as containers for other elements.
The parameter `html` is optional.
It accepts a string that sets the inner HTML of the new `&lt;div&gt;&lt;/div&gt;`.

Parameters: ~
                🔢 `{String} [html] inner HTML for the new `&lt;div&gt;&lt;/div&gt;` element.` (unknown)
~
...
See also: ~
   |help p5-createDiv| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:537
~


p5-DOM_createElement() 📄 ⚡
|createElement|(tag, {String} [content] HTML content to insert into the element.) ⚡ Function

Creates a new <a href="#/p5.Element">p5.Element</a> object.
The first parameter, `tag`, is a string an HTML tag such as `'h5'`.
The second parameter, `content`, is optional.
It's a string that sets the HTML content to insert into the new element.
New elements have no content by default.

Parameters: ~
                📝 `tag` (String) - tag for the new element.
                🔢 `{String} [content] HTML content to insert into the element.` (unknown)
~
...
See also: ~
   |help p5-createElement| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2542
~


p5-DOM_createFileInput() 📄 ⚡
|createFileInput|(callback, {Boolean} [multiple] allow multiple files to be selected.) ⚡ Function
...
The first parameter, `callback`, is a function that's called when the file loads.
The callback function should have one parameter, `file`, that's a <a href="#/p5.File">p5.File</a> object.
The second parameter, `multiple`, is optional.
It's a boolean value that allows loading multiple files if `set` to `true`.
If `true`, `callback` will be called once per file.

Parameters: ~
                ⚡ `callback` (Function) - function to call once the file loads.
                🔢 `{Boolean} [multiple] allow multiple files to be selected.` (unknown)
~

Returns: ~
                🔢 Returns p5.File: new <a href="#/p5.File">p5.File</a> object.
~
...
See also: ~
   |help p5-createFileInput| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2044
~


p5-DOM_createImg() 📄 ⚡
|createImg|(src, alt, {String} [crossOrigin] crossOrigin property to use when fetching the image., {Function} [successCallback] function to call once the image loads. The new image will be passed) ⚡ Function

Parameters: ~
                📝 `src` (String)
                📝 `alt` (String)
                🔢 `{String} [crossOrigin] crossOrigin property to use when fetching the image.` (unknown)
                🔢 `{Function} [successCallback] function to call once the image loads. The new image will be passed` (unknown)
~
...
See also: ~
   |help p5-createImg| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:702
~


p5-DOM_createInput() 📄 ⚡
|createInput|({String} [value]) ⚡ Function
...
See also: ~
   |help p5-createInput| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:1934
~
...
See also: ~
   |help p5-createMedia| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2071
~


p5-DOM_createP() 📄 ⚡
|createP|({String} [html] inner HTML for the new `&lt;p&gt;&lt;/p&gt;` element.) ⚡ Function

Creates a paragraph element.
`&lt;p&gt;&lt;/p&gt;` elements are commonly used for paragraph-length `text`.
The parameter `html` is optional.
It accepts a string that sets the inner HTML of the new `&lt;p&gt;&lt;/p&gt;`.

Parameters: ~
                🔢 `{String} [html] inner HTML for the new `&lt;p&gt;&lt;/p&gt;` element.` (unknown)
~
...
See also: ~
   |help p5-createP| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:572
~


p5-DOM_createSelect() 📄 ⚡
|createSelect|(existing) ⚡ Function

Parameters: ~
                📦 `existing` (Object) - select element to wrap, either as a <a href="#/p5.Element">p5.Element</a> or
~
...
See also: ~
   |help p5-createSelect| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:1331
~


p5-DOM_createSlider() 📄 ⚡
|createSlider|(min, max, {Number} [value] default value of the slider., {Number} [step] size for each step in the slider's range.) ⚡ Function
...
The third parameter, `value`, is optional.
It's a number that sets the slider's default value.
The fourth parameter, `step`, is also optional.
It's a number that sets the spacing between each value in the slider's range.
Setting `step` to 0 allows the slider to `move` smoothly from `min` to `max`.

Parameters: ~
                🔢 `min` (Number) - minimum value of the slider.
                🔢 `max` (Number) - maximum value of the slider.
                🔢 `{Number} [value] default value of the slider.` (unknown)
                🔢 `{Number} [step] size for each step in the slider's range.` (unknown)
~
...
See also: ~
   |help p5-createSlider| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:909
~


p5-DOM_createSpan() 📄 ⚡
|createSpan|({String} [html] inner HTML for the new `&lt;span&gt;&lt;/span&gt;` element.) ⚡ Function

Creates a `&lt;span&gt;&lt;/span&gt;` element.
`&lt;span&gt;&lt;/span&gt;` elements are commonly used as containers for inline elements.
For example, a `&lt;span&gt;&lt;/span&gt;` can hold part of a sentence that's a <span style="`color`: deeppink;">different</span> style.
The parameter `html` is optional.
It accepts a string that sets the inner HTML of the new `&lt;span&gt;&lt;/span&gt;`.

Parameters: ~
                🔢 `{String} [html] inner HTML for the new `&lt;span&gt;&lt;/span&gt;` element.` (unknown)
~
...
See also: ~
   |help p5-createSpan| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:643
~


p5-DOM_createVideo() 📄 ⚡
|createVideo|(src, {Function} [callback] function to call once the video is ready to play.) ⚡ Function

Creates a `&lt;video&gt;` element for simple audio/video playback.
`createVideo()` returns a new <a href="#/p5.MediaElement">p5.MediaElement</a> object.
Videos are shown by default.
They can be hidden by calling `video.hide()` and drawn to the canvas using <a href="#/p5/`image`">`image`()</a>.
The first parameter, `src`, is the path the video.
If a single string is passed, as in `'assets/topsecret.mp4'`, a single video is loaded.
An array of strings can be used to load the same video in different formats.
For example, `['assets/topsecret.mp4', 'assets/topsecret.ogv', 'assets/topsecret.webm']`.
This is useful for ensuring that the video can play across different browsers with different capabilities.
See <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Supported_media_formats'>MDN</a> for more information about supported formats.
The second parameter, `callback`, is optional.
It's a function to call once the video is ready to play.

Parameters: ~
                🔢 `src` (String|String[]) - path to a video file, or an array of paths for
                🔢 `{Function} [callback] function to call once the video is ready to play.` (unknown)
~
...
See also: ~
   |help p5-createVideo| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2206
~
...
See also: ~
   |help p5-display| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3558
~


p5-DOM_draggable() 📄 ⚡
|draggable|({p5.Element} [elmnt]  another <a href="#/p5.Element">p5.Element</a>.) ⚡ Function

Makes the element draggable.
The parameter, `elmnt`, is optional.
If another <a href="#/p5.Element">p5.Element</a> object is passed, as in `myElement.draggable(otherElement)`, the other element will become draggable.

Parameters: ~
                🔢 `{p5.Element} [elmnt]  another <a href="#/p5.Element">p5.Element</a>.` (unknown)
~
...
See also: ~
   |help p5-draggable| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:4013
~


p5-DOM_drop() 📄 ⚡
|drop|(callback, {Function} [fxn]     called once when any files are dropped.) ⚡ Function
...
The callback function should have one parameter, `file`, that's a <a href="#/p5.File">p5.File</a> object.
If the user drops multiple files on the element, `callback`, is called once for each file.
The second parameter, `fxn`, is a function to call when the browser detects one or more dropped files.
The callback function should have one parameter, `event`, that's a <a href="https://developer.mozilla.org/en-US/docs/Web/API/DragEvent">DragEvent</a>.

Parameters: ~
                ⚡ `callback` (Function) - called when a file loads. Called once for each file dropped.
                🔢 `{Function} [fxn]     called once when any files are dropped.` (unknown)
~
...
See also: ~
   |help p5-drop| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3900
~


p5-DOM_hasClass() 📄 ⚡
|hasClass|(c {String} name of class to check.) ⚡ Function

Checks if a class is already applied to element.

Parameters: ~
                🔢 `c {String} name of class to check.` (unknown)
~
...
See also: ~
   |help p5-hasClass| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2673
~
...
See also: ~
   |help p5-hide| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3557
~


p5-DOM_html() 📄 ⚡
|html|({String} [html] the HTML to be placed inside the element, {boolean} [append] whether to append HTML to existing) ⚡ Function

Parameters: ~
                🔢 `{String} [html] the HTML to be placed inside the element` (unknown)
                🔢 `{boolean} [append] whether to append HTML to existing` (unknown)
~

See also: ~
   |help p5-html| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2968
~
...
`myElement.input()` is often used to with `text` inputs and sliders.
Calling `myElement.input(false)` disables the function.
...
See also: ~
   |help p5-input| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:473
~


p5-DOM_position() 📄 ⚡
|position|({Number} [x] x-position relative to top-left of window (optional), {Number} [y] y-position relative to top-left of window (optional), {String} [positionType] it can be static, fixed, relative, sticky, initial or inherit (optional)) ⚡ Function

Parameters: ~
                🔢 `{Number} [x] x-position relative to top-left of window (optional)` (unknown)
                🔢 `{Number} [y] y-position relative to top-left of window (optional)` (unknown)
                🔢 `{String} [positionType] it can be static, fixed, relative, sticky, initial or inherit (optional)` (unknown)
~

See also: ~
   |help p5-position| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3038
~
...
Source: ~
                ../temp/src/dom/dom.js:3761
~


p5-DOM_removeAttribute() 📄 ⚡
|removeAttribute|(attr) ⚡ Function

Removes an attribute from the element.
The parameter `attr` is the attribute's name as a string.
For example, calling `myElement.removeAttribute('align')` removes its `align` attribute if it's been `set`.
...
See also: ~
   |help p5-removeAttribute| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3396
~


p5-DOM_removeClass() 📄 ⚡
|removeClass|(class) ⚡ Function
...
See also: ~
   |help p5-removeClass| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2630
~


p5-DOM_removeElements() 📄 ⚡
|removeElements|() ⚡ Function

Removes all elements created by p5.js, including any event handlers.
There are two exceptions: canvas elements created by <a href="#/p5/`createCanvas`">`createCanvas`()</a> and <a href="#/p5.Renderer">p5.Render</a> objects created by <a href="#/p5/`createGraphics`">`createGraphics`()</a>.
...
See also: ~
   |help p5-removeElements| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:322
~


p5-DOM_select() 📄 ⚡
|select|(selectors, {String|p5.Element|HTMLElement} [container] CSS selector string, <a href="#/p5.Element">p5.Element</a>, or) ⚡ Function

Searches the page for the first element that matches the given <a href="https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics#different_types_of_selectors" target="_blank">CSS selector string</a>.
The selector string can be an ID, class, tag name, or a combination.
`select()` returns a <a href="#/p5.Element">p5.Element</a> object if it finds a match and `null` if not.
The second parameter, `container`, is optional.
It specifies a container to search within.
`container` can be CSS selector string, a <a href="#/p5.Element">p5.Element</a> object, or an <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement" target="_blank">HTMLElement</a> object.

Parameters: ~
                📝 `selectors` (String) - CSS selector string of element to search for.
                🔢 `{String|p5.Element|HTMLElement} [container] CSS selector string, <a href="#/p5.Element">p5.Element</a>, or` (unknown)
~

Returns: ~
                🔢 Returns p5.Element|null: <a href="#/p5.Element">p5.Element</a> containing the element.
~
...
See also: ~
   |help p5-select| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:98
~


p5-DOM_selectAll() 📄 ⚡
|selectAll|(selectors, {String|p5.Element|HTMLElement} [container] CSS selector string, <a href="#/p5.Element">p5.Element</a>, or) ⚡ Function

Searches the page for all elements that matches the given <a href="https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics#different_types_of_selectors" target="_blank">CSS selector string</a>.
The selector string can be an ID, class, tag name, or a combination.
`selectAll()` returns an array of <a href="#/p5.Element">p5.Element</a> objects if it finds any matches and an empty array if none are found.
The second parameter, `container`, is optional.
It specifies a container to search within.
`container` can be CSS selector string, a <a href="#/p5.Element">p5.Element</a> object, or an <a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement" target="_blank">HTMLElement</a> object.
...
Returns: ~
                🔢 Returns p5.Element[]: array of <a href="#/p5.Element">p5.Element</a>s containing any elements found.
~
...
See also: ~
   |help p5-selectAll| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:192
~
...
See also: ~
   |help p5-show| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3524
~
...
Parameters: ~
                📝 `property` (String)
                🔢 `value` (String|p5.Color) - value to assign to the property.
~
...
Source: ~
                ../temp/src/dom/dom.js:3225
~


p5-DOM_toggleClass() 📄 ⚡
|toggleClass|(c {String} class name to toggle.) ⚡ Function

Toggles whether a class is applied to the element.

Parameters: ~
                🔢 `c {String} class name to toggle.` (unknown)
~
...
See also: ~
   |help p5-toggleClass| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2710
~
...
See also: ~
   |help p5-value| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:3482
~


PROPERTIES                                                   *p5-DOM-properties*

p5-DOM_data() 📄 🔧
|data| ⚡ Function

A string containing the file's data.
Data can be either `image` data, `text` contents, or a parsed object in the case of JSON and <a href="#/p5.XML">p5.XML</a> objects.
...
See also: ~
   |help p5-data| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5805
~
...
Underlying <a href="https://developer.mozilla.org/en-US/docs/Web/API/File" target="_blank">File</a> object.
All `File` properties and methods are accessible.
...
Source: ~
                ../temp/src/core/p5.Element.js:109
~
...
See also: ~
   |help p5-name| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5733
~
...
See also: ~
   |help p5-prop| for detailed help on this symbol~

Source: ~
                ../temp/src/core/p5.Element.js:1019
~
...
See also: ~
   |help p5-size| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5767
~
...
For example, a file with an `'`image`'` <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types" target="_blank">MIME type</a> may have a subtype such as ``png`` or ``jpeg``.
...
See also: ~
   |help p5-subtype| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5698
~
...
The file <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types" target="_blank">MIME type</a> as a string.
...
See also: ~
   |help p5-VIDEO| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:2261
~
...
Source: ~
                ../temp/src/core/p5.Element.js:101
~


VARIABLES                                                   *p5-DOM-variables*
...
If no element is provided, as in `myElement.connect()`, the element connects to the main output.
All connections are removed by the `.disconnect()` method.
Note: This method is meant to be used with the p5.sound.js addon library.

See also: ~
   |help p5-audioContext| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5112
~
...
See also: ~
   |help p5-children| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:225
~
...
See also: ~
   |help p5-elt| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:644
~
...
The first parameter, `time`, is the time, in seconds, when the function should run.
This value is passed to `callback` as its first argument.
...
See also: ~
   |help p5-id| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:5316
~
...
See also: ~
   |help p5-isTouch| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:4014
~
...
See also: ~
   |help p5-mainOutput| for detailed help on this symbol~
...
See also: ~
   |help p5-node| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:482
~
...
The parameter, `shouldAutoplay`, is optional.
Calling `media.autoplay()` without an argument causes the media to play automatically.
If `true` is passed, as in `media.autoplay(true)`, the media will automatically play.
If `false` is passed, as in `media.autoPlay(false)`, it won't play automatically.
...
See also: ~
   |help p5-oldVal| for detailed help on this symbol~

Source: ~
                ../temp/src/dom/dom.js:4601
~
...
See also: ~
   |help p5-timeout| for detailed help on this symbol~
